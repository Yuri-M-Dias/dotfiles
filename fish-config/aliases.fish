...
# Easy to calculate last uptime (needs dateutils and journalctl)
alias timeSinceLastStartup="dateutils.ddiff -f%H:%M:%S (journalctl -n4 -u sleep.target -o short-iso | tail -n 1 | cut -d' ' -f 1) now"
